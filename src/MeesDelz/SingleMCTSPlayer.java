...
public class SingleMCTSPlayer {
    ...
    private ParameterOptimizer paramOpt;
    /**
     * Root of the tree.
     */
...
//            double delta = rollOut(tempState);
            ...
            this.paramOpt.update(delta,param);
     ...
     */
    private SingleTreeNode treePolicy(StateObservation currentObservation,ParameterSet param) {
        ...
        while (!(currentObservation.isGameOver()))
        {
            if (currentNode.notFullyExpanded()) {
                ...
                SingleTreeNode next = currentNode.selectChild(param);
